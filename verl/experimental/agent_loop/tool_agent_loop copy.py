...
class ToolAgentLoop(AgentLoopBase):
    ...
    async def _handle_interacting_state(self, agent_data: AgentData) -> AgentState:
        ...
        # Pass image_data to interaction for reward model calls
        interaction_kwargs_with_images = {
        ...
        (
            ...
            agent_data.request_id, agent_data.messages, **interaction_kwargs_with_images
        )
