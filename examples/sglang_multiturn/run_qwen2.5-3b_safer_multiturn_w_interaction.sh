...
export WANDB_NOTES="SaFeR-Steer multi-turn RL training 3b"
...
python3 -m verl.trainer.main_ppo \
    ...
    data.max_response_length=$((1024 * 12)) \
    data.filter_overlong_prompts=True \
    data.truncation='left' \
    data.return_raw_chat=True \
    actor_rollout_ref.model.path=${MODEL_PATH:-models/safer-steer-3b-sft} \
    ...
    trainer.experiment_name='qwen2.5-3b_safer-steer-grpo' \
