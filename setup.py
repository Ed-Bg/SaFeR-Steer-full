...
setup(
    ...
    url="https://github.com/Ed-Bg/SaFeR-Steer-full",
    license="Apache 2.0",
    author="Haolong Hu et al.",
    author_email="huahui.yi1@gmail.com, zgzeng@hust.edu.cn",
    description="SaFeR-Steer: Evolving Multi-Turn MLLMs via Synthetic Bootstrapping and Feedback Dynamics",
